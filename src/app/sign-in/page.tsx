      ...
      <main className="mx-auto grid w-full max-w-5xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.85fr] lg:px-8">
        <section className="surface-strong rounded-[36px] p-8 md:p-10">
          ...
          <h1 className="mt-4 font-display text-5xl font-bold tracking-tight text-white">
            Authenticate with Steam, then sync Deadlock rank.
          </h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
            Deadlock Pro uses Steam OpenID for sign-in. Once the Steam identity is verified, the
            app can call the configured Deadlock API with the Steam ID and store the returned rank
            on the user profile.
          </p>
