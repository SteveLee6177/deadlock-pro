      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 py-12 sm:px-6 lg:px-8">
        <section className="surface-strong rounded-[36px] p-8 md:p-10">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">
            This is the scene-awareness layer of Deadlock Pro: featured tournaments, quick-entry
            links, and Twitch embeds for the events players are already following.
          </p>
        </section>
